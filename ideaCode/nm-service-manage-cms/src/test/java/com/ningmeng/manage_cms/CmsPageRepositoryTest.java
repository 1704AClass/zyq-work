...
public class CmsPageRepositoryTest {
    ...
    public void testUpdate() {
        Optional<CmsPage> optional = cmsPageRepository.findById("5b17a2c511fe5e0c409e5eb3");
    ...
    public void testFindAll() {
        ...
        Page<CmsPage> all = cmsPageRepository.findAll(example, pageable); System.out.println(all);
    }
}
