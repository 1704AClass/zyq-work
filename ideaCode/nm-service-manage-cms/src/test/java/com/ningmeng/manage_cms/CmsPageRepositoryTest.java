...
public class CmsPageRepositoryTest {
    ...
    public void findAll(){
        ...
        for (CmsPage cmsPage:list){
            System.out.println(cmsPage.getPageAliase());
        }
    }
    //分页测试
    @Test
    ...
    public void testDelete() {
        cmsPageRepository.deleteById("5e42b72759989e2d4875c14c");
    }
    //修改
    @Test
    public void testUpdate() {
        Optional<CmsPage> optional = cmsPageRepository.findById("5e42b8aa59989e0eccbd379d");
